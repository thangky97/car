...
<head>
    ...
    <meta charset="utf-8">
    <title>Login | CAR - Admin & Dashboard</title>
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card overflow-hidden">
                        <div class="bg-primary">
                            <div class="text-primary text-center p-4">
                                ...
                                <p class="text-white-50">Đăng nhập tiếp tục vào CAR.</p>
                    ...
                    <div class="mt-5 text-center">
                        <p class="mb-0">©
                            ...
                            </script> CAR with <i class="mdi mdi-heart text-danger"></i> by developer
                        </p>
                    </div>
