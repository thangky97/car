                                        ...
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    ...
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider1.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider2.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider3.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider4.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider5.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider6.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider7.jpg"
                                    ...
                                    <div class="thumb">
                                        <div class="single_product">
                                            <div class="single_item">
                                                <div class="thumb">
                                                    <div class="tags">FEATURED</div>
                                                    <img class="img-fluid" src="images/listing/sp4_tab_slider8.jpg"
                    ...
                    <div class="popular_listing_sliders single_page6_tabs row pr15">
                        ...
                        <div class="nav nav-tabs col-lg-12" role="tablist">
                            ...
                            <button class="nav-link" id="nav-features-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false">Trang thiết bị</button>
                        ...
                        <div class="tab-content col-lg-12" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-description" role="tabpanel"
                                ...
                                <div class="listing_single_description bdr_none pl0 pr0">
                                    <h4 class="mb30">Mô tả <span class="float-end body-color fz13">ID
                                            #9535</span></h4>
                            ...
                            <div class="tab-pane fade" id="nav-features" role="tabpanel"
                                ...
                                <div class="user_profile_service bdr_none pl0 pr0">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 class="title">Trang thiết bị</h4>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                <div class="user_profile_review bdr_none pl0 pr0">
                                    <div class="energy_class">
                                        <h4 class="mb30">Các bình luận</h4>
                    ...
                    <div class="sidebar_seller_contact bgc-f9">
                        <div class="d-flex align-items-center mb30">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mt0 mb5 fz16 heading-color fw600">Gọi trực tiếp</h5>
                                <p class="mb0 tdu"><span class="flaticon-phone-call pr5 vam"></span>(302) 555-0107
                                </p>
                            </div>
                        </div>
                        <h4 class="mb30">Liên hệ người bán</h4>
                        <form action="#">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <input class="form-control form_control" type="text" placeholder="Tên">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <input class="form-control form_control" type="text" placeholder="Số điện thoại">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-block btn-thm mt10 mb20">Gửi hỗ trợ</button>
                                    ...
                                    <div class="thmb_cntnt2">
                                        <ul class="mb0">
                                            <li class="list-inline-item"><a class="text-white" href="#"><span
                                                        class="flaticon-photo-camera mr3"></span> 22</a>
                                        </ul>
                                    </div>
