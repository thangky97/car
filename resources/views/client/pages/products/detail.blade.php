...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-car-single-v4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:47:21 GMT -->
...
<head>
    ...
    <!-- Title -->
    <title>MG Miền Bắc - Website bán ô tô MG</title>
    <!-- Favicon -->
...
<body>
    <div class="wrapper ovh">
                    ...
                    <li class="mm-add-listing">
                        <span class="border-none">
                            <span class="mmenu-contact-info">
                                ...
                                <span class="phone-num"><i class="flaticon-clock"></i> <a href="#">Mon - Fri
                                        8:00 - 18:00</a></span>
                            </span>
        ...
        <!-- Single Page Slider Content Grid View -->
        <section class="single-page-style bgc-thm2 pb40 mt70-992 pt30">
            <div class="container">
                <div class="row mb30">
                    <div class="col-lg-7 col-xl-8">
                        <div class="single_page_heading_content single_page4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="single_product_grid single_page4">
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        ...
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider1.jpg"
                                                            alt="sp4_tab_slider1.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider2.jpg"
                                                            alt="sp4_tab_slider2.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider3.jpg"
                                                            alt="sp4_tab_slider3.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider4.jpg"
                                                            alt="sp4_tab_slider4.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider5.jpg"
                                                            alt="sp4_tab_slider5.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider6.jpg"
                                                            alt="sp4_tab_slider6.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider7.jpg"
                                                            alt="sp4_tab_slider7.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                                            ...
                                            <div class="single_product">
                                                <div class="single_item">
                                                    <div class="thumb">
                                                        <div class="tags">FEATURED</div>
                                                        <img class="img-fluid"
                                                            src="images/listing/sp4_tab_slider8.jpg"
                                                            alt="sp4_tab_slider8.jpg">
                                                    </div>
                                                </div>
                                                <div class="overlay_icon"><a
                                                        class="video_popup_btn popup-img popup-youtube"
                            ...
                            <div class="tab-content col-lg-12" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-description" role="tabpanel"
                                    ...
                                    <div class="listing_single_description bdr_none pl0 pr0">
                                        <h4 class="mb30">Description <span class="float-end body-color fz13">ID
                                                #9535</span></h4>
                                        <p class="first-para">The all-new Volvo XC60 is a terrific luxury compact SUV.
                                            It's been fully redesigned for 2017 and features improvements across the
                                            board. These changes bump the vehicle from its previous midpack standing; it
                                            now resides with some of the best in the class. Some of the most notable
                                            improvements include a state-of-the-art infotainment system, more legroom
                                            for rear-seat riders, and peppy engine choices.</p>
                            ...
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-block btn-thm mt10 mb20">Send
                                            Message</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="text-center text-md-end mb30-sm">
                            <a href="#" class="more_listing">Show All Cars <span class="icon"><span
                                ...
                                <div class="car-listing">
                                    ...
                                    <div class="details">
                                        <div class="wrapper">
                                            ...
                                            <h6 class="title"><a href="page-car-single-v1.html">BMW M8 Gran Coupe
                                                    Base - 2021</a></h6>
                                            <div class="listign_review">
                                                <ul class="mb0">
                                                    <li class="list-inline-item"><a href="#"><i
                                ...
                                <div class="car-listing">
                                    ...
                                    <div class="details">
                                        <div class="wrapper">
                                            ...
                                            <h6 class="title"><a href="page-car-single-v1.html">Nıssan Qasqai - Sky
                                                    Pack</a></h6>
                                            <div class="listign_review">
                                                <ul class="mb0">
                                                    <li class="list-inline-item"><a href="#"><i
...
<!-- Mirrored from creativelayers.net/themes/voiture-html/page-car-single-v4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:47:25 GMT -->
